...
export class Skus {
      ...
      if (statusCode === 200) {
        ...
        try {
          if (parsedResponse !== null && parsedResponse !== undefined) {
            let resultMapper = Mappers.StorageSkuListResult;
   ...
   *
   *                      {Models.StorageSkuListResult} [result]   - The deserialized result object if an error did not occur.
   *                      See {@link Models.StorageSkuListResult} for more
   *                      information.
   *
   ...
   */
  list(): Promise<Models.StorageSkuListResult>;
  list(options: msRest.RequestOptionsBase): Promise<Models.StorageSkuListResult>;
  ...
  list(options?: msRest.RequestOptionsBase, callback?: msRest.ServiceCallback<Models.StorageSkuListResult>): any {
    if (!callback && typeof options === 'function') {
      callback = options;
      options = undefined;
    }
    let cb = callback as msRest.ServiceCallback<Models.StorageSkuListResult>;
    if (!callback) {
      return this.listWithHttpOperationResponse(options).then((operationRes: msRest.HttpOperationResponse) => {
        return Promise.resolve(operationRes.bodyAsJson as Models.StorageSkuListResult);
      }).catch((err: Error) => {
        return Promise.reject(err);
      });
    } else {
      msRest.promiseToCallback(this.listWithHttpOperationResponse(options))((err: Error, data: msRest.HttpOperationResponse) => {
        ...
        let result = data.bodyAsJson as Models.StorageSkuListResult;
